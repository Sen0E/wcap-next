...
// Custom GUIDs — defined as static to avoid cross-TU duplication since audio.c does not include initguid.h
...
static const GUID IID_IActivateAudioInterfaceCompletionHandler = {0x41d949ab, 0x9862, 0x444a, {0x80, 0xf6, 0xc2, 0x61, 0x33, 0x4d, 0xa5, 0xeb}};
